...
PROFILE_SETTINGS = {
    "Home": {"sat_gain": 1.2, "use_white_block": True, "white_block_thresh": 0.08},
    "University": {"sat_gain": 1.7, "use_white_block": True, "white_block_thresh": 0.08},
}
...
def analyze_frame(frame: np.ndarray, profile: str = "Home") -> tuple[np.ndarray, DetectionResult]:
    ...
    blocked = red_ratio > green_ratio
    if cfg["use_white_block"]:
        blocked = blocked or (white_ratio > cfg["white_block_thresh"])
